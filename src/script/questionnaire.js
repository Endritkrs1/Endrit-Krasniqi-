...
const questionnaire = [
    {
        qlabel: "En quelle année Max Verstappen est-il né ?",
        qid: 1,
        reponses: [
            { rlabel: "1995", rid: 1 },
            { rlabel: "1996", rid: 2 },
    ...
    {
        qlabel: "Quelle est la nationalité de Max Verstappen ?",
        qid: 2,
        reponses: [
            { rlabel: "Belge", rid: 1 },
            { rlabel: "Néerlandaise", rid: 2 },
            { rlabel: "Allemande", rid: 3 },
            { rlabel: "Française", rid: 4 }
        ]
    },
    {
        qlabel: "En quelle année a-t-il remporté son premier Grand Prix ?",
        qid: 3,
        reponses: [
            { rlabel: "2015", rid: 1 },
            { rlabel: "2016", rid: 2 },
    ...
    {
        qlabel: "Combien de titres mondiaux a-t-il remportés entre 2021 et 2023 ?",
        qid: 4,
        reponses: [
            { rlabel: "1", rid: 1 },
            { rlabel: "2", rid: 2 },
...
const bonnesReponses = "A1_3-A2_2-A3_2-A4_3";
let reponses = "";
let questionIndex = 0;
